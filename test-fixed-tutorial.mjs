// Test FIXED tutorial pattern solutions
...
console.log("Match:", JSON.stringify(grid1) === JSON.stringify([[0,0,0],[0,0,0],[0,0,0]]));
...
// Apply second click: bottom center (2,1) 
grid2 = simulateClick(grid2, 2, 1);
console.log("After click (2,1):", JSON.stringify(grid2));
console.log("Expected: [[0,0,0],[0,0,0],[0,0,0]]");
