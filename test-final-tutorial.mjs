// Test FINAL tutorial pattern solutions
...
// Apply first click: top-left (0,0)
grid2 = simulateClick(grid2, 0, 0);
console.log("After click (0,0):", JSON.stringify(grid2));

// Apply second click: bottom-right (2,2) 
grid2 = simulateClick(grid2, 2, 2);
console.log("After click (2,2):", JSON.stringify(grid2));
